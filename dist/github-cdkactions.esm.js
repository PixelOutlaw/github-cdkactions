...
var GradlePluginPullRequestWorkflow = /*#__PURE__*/function (_Workflow) {
  ...
  function GradlePluginPullRequestWorkflow(scope) {
    ...
    new Job(_assertThisInitialized(_this), "pull-request", {
      name: "CI",
...
var GradlePluginPrepareForReleaseWorkflow = /*#__PURE__*/function (_Workflow) {
  ...
  function GradlePluginPrepareForReleaseWorkflow(scope) {
    ...
    new Job(_assertThisInitialized(_this), "prepare-for-release", {
      name: "Prepare For Release",
      runsOn: "ubuntu-latest",
      steps: [{
        name: "Check-out Code",
...
var GradlePluginReleaseWorkflow = /*#__PURE__*/function (_Workflow) {
  ...
  function GradlePluginReleaseWorkflow(scope) {
    ...
    new Job(_assertThisInitialized(_this), "release", {
      name: "Release",
      runsOn: "ubuntu-latest",
      steps: [{
        name: "Check-out Code",
...
export { GradlePluginPrepareForReleaseWorkflow, GradlePluginPullRequestWorkflow, GradlePluginReleaseWorkflow };
//# sourceMappingURL=github-cdkactions.esm.js.map
